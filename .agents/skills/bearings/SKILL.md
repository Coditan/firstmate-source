...
- Render both when both are present, and never drop the running work because a decision was asked about that home - losing work already under way behind a question about it is the failure this surface was widened against.
