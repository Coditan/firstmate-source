...
So what survives binds the granting vessel rather than the seat; how that vessel must deliver omega text to a secondmate is not settled by this change, and nothing in this document is delivered to that seat.
