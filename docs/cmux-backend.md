...
The shared target-existence probe reports absence only from completed workspace, surface, and expected-label inventories, and reports unreadable when any inventory command or JSON parse fails.
