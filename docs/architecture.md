...
Teardown is fail-closed for ship worktrees: dirty worktrees refuse, committed work must be landed, and a pooled worktree held by another live task is never returned.
