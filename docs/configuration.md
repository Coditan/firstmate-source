...
FM_TAILSCALE_SOCKET=    # explicit tailscaled socket path the `tailscale` client dials, read ahead of the VESSEL_TAILNET_SOCKET declaration the vessel runtime exports; unset in both means the client keeps its own default (docs/lavish-access.md)
