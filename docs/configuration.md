...
FM_DEFERRED_CHECK_PAYLOAD_MAX=600      # characters of a deferred check's output carried in the wake payload; the full text always stays in state/.deferred/<name>/out, which the payload names
