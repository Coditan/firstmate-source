...
Every `FIRSTMATE_UPDATE_AVAILABLE:` finding and unreachable-base `FIRSTMATE_UPDATE_STUCK:` refusal likewise names the update-source URL and the hop that supplied it.
