...
The away delivery repair line names the concrete restart, `bin/fm-afk-launch.sh start`, and never tells an away session to arm a session delivery wait.
