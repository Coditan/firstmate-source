...
This contract covers words firstmate invented for its own operation, never a proper noun: what a tool, repository, or product is actually called is never translated, in any language, because a translated proper noun is unfindable.
