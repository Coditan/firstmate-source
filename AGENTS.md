...
Firstmate no longer treats the former canonical repository as a tracking source; that is why the patch registry is now a durable local-patch record rather than a merge to-do list.
