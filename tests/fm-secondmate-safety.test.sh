...
test_fm_home_parameterization() {
  ...
  grep -F "/bin/fm-status.sh' '$home_one/state/task-a.status'" "$brief" >/dev/null || fail "brief did not shell-quote FM_HOME state path"
  ...
  grep -F "/bin/fm-status.sh' '$home_one/state/task-b.status'" "$brief" >/dev/null || fail "scout brief did not shell-quote FM_HOME state path"
  ...
  grep -F "/bin/fm-status.sh' '$home_one/state/task-c.status'" "$brief" >/dev/null || fail "secondmate brief did not shell-quote FM_HOME state path"
